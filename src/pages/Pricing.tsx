...
import { CheckCircle, X, Sparkles, Zap, Users, ArrowRight, Shield, Globe, Heart } from "lucide-react";
...
const FEATURES_COMPARISON = [
  ...
  { feature: "Proveedores IA", free: "Todos (con tu key)", pro: "Todos (con tu key)", icon: <Sparkles className="h-4 w-4" /> },
  { feature: "Formatos de exportación", free: "6 formatos", pro: "6 formatos", icon: <Globe className="h-4 w-4" /> },
          ...
          <Card className="relative border-2 hover:border-violet-500/30 transition-colors">
            <CardContent className="p-8">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-2 text-sm">
                  <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0" />
                  <span>Todos los proveedores IA (con tu key)</span>
                </li>
                <li className="flex items-center gap-2 text-sm">
                  <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0" />
